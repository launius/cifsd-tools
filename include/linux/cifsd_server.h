 ...
 * Notify flags.
 */
#define CIFSD_NOTIFY_FLAG_INVALID			0
#define CIFSD_NOTIFY_FLAG_ADDED				0x00000001
#define CIFSD_NOTIFY_FLAG_REMOVED			0x00000002
#define CIFSD_NOTIFY_FLAG_MODIFIED			0x00000003
#define CIFSD_NOTIFY_FLAG_RENAMED_OLD_NAME	0x00000004
#define CIFSD_NOTIFY_FLAG_RENAMED_NEW_NAME	0x00000005
#define CIFSD_NOTIFY_FLAG_ADDED_STREAM		0x00000006
#define CIFSD_NOTIFY_FLAG_REMOVED_STREAM	0x00000007
#define CIFSD_NOTIFY_FLAG_MODIFIED_STREAM	0x00000008
#define CIFSD_NOTIFY_FLAG_REMOVED_BY_DELETE	0x00000009
